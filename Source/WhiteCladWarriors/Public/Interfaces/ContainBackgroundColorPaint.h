...
#include "ContainBackgroundColorPaint.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UContainBackgroundColorPaint : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class WHITECLADWARRIORS_API IContainBackgroundColorPaint
{
	GENERATED_BODY()
